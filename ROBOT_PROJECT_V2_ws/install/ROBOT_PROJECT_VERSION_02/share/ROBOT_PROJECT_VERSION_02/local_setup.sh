...
: ${AMENT_CURRENT_PREFIX:="/root/ROBOT_PROJECT_V2_ws/install/ROBOT_PROJECT_VERSION_02"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ROBOT_PROJECT_VERSION_02/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ROBOT_PROJECT_VERSION_02/environment/path.sh"
